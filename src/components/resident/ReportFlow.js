          ...
          <div className="rf-panel a0">
            ...
            <div className="rf-form">
              ...
              <div className="field">
                ...
                <button className={`rf-photo ${form.photo?'added':''}`} onClick={()=>upd('photo',!form.photo)}>
                  <span className="rf-photo-icon">{form.photo?'✓':'📷'}</span>
                  <div>
                    <div className="rf-photo-title">{form.photo?'Photo attached — IMG_2025.jpg (2.4 MB)':'Upload Photo'}</div>
                    <div className="rf-photo-sub">{form.photo?'Tap to remove':'Helps maintenance understand the issue faster. Drag & drop or click.'}</div>
                  </div>
                  {!form.photo&&<span className="btn btn-secondary btn-sm" style={{marginLeft:'auto',flexShrink:0}}>Browse</span>}
                </button>
              </div>
            </div>
            <div className="rf-footer">
            ...
            <div className="rf-review-card card">
              <div className="rf-rv-grid">
                ...
                <div className="rf-rv-item">
                  ...
                  <div className="rf-rv-val">{form.photo?'✓ Attached':'None'}</div>
                </div>
                <div className="rf-rv-item">
        ...
        {step===4&&submitted&&(
          <div className="rf-success a0">
            ...
            <div className="rf-success-actions">
              ...
              <button className="btn btn-secondary btn-md" onClick={()=>{setStep(1);setForm({type:'',location:'',description:'',priority:'Normal',photo:false});setSubmitted(null);}}>Submit Another</button>

        ...
        <div className="mr-detail">
          ...
          <div className="mr-dscroll">
            ...
            <div className="flex gap-2" style={{marginBottom:20}}>
              ...
              {sel.photo && <span className="chip" style={{background:'var(--blue-dim)',color:'var(--blue)',border:'1px solid rgba(37,99,235,0.2)',padding:'6px 14px',fontSize:12.5}}>📷 Photo Attached</span>}
            </div>
